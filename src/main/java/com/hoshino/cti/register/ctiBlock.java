...
public class ctiBlock {
    ...
    public static final RegistryObject<Block> unipolar_magnet = BLOCK.register("unipolar_magnet", () -> new CrystalClusterBlock(SoundEvents.AMETHYST_BLOCK_CHIME,7,3, BlockBehaviour.Properties.of(Material.AMETHYST).noOcclusion().sound(SoundType.AMETHYST_CLUSTER).strength(5.5F).lightLevel((BlockStateBase)-> 5)));
    ...
    public static final RegistryObject<Block> fracture_silicon = BLOCK.register("fracture_silicon", () -> new CrystalClusterBlock(SoundEvents.AMETHYST_BLOCK_CHIME,7,3, BlockBehaviour.Properties.of(Material.AMETHYST).noOcclusion().sound(SoundType.AMETHYST_CLUSTER).strength(2.5F).lightLevel((BlockStateBase)-> 5)));
    public static final RegistryObject<Block> rasterite = BLOCK.register("rasterite", () -> new CrystalClusterBlock(SoundEvents.AMETHYST_BLOCK_CHIME,7,3, BlockBehaviour.Properties.of(Material.AMETHYST).noOcclusion().sound(SoundType.AMETHYST_CLUSTER).strength(2.5F).lightLevel((BlockStateBase)-> 5)));
