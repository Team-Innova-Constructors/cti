...
public class TinkerRailgunRd2 extends EntityRenderer<TinkerRailgunProjectile> {
    public ItemRenderer itemRenderer;
    public TinkerRailgunRd2(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    ...
    public void render(TinkerRailgunProjectile p_114485_, float p_114486_, float p_114487_, PoseStack p_114488_, MultiBufferSource p_114489_, int p_114490_) {
        if (p_114485_.stack!=null){
            p_114488_.pushPose();
            p_114488_.mulPose(Vector3f.YP.rotationDegrees(Mth.lerp(p_114487_, p_114485_.yRotO, p_114485_.getYRot()) - 90f));
            p_114488_.mulPose(Vector3f.ZP.rotationDegrees(Mth.lerp(p_114487_, p_114485_.xRotO, p_114485_.getXRot())-45f));
